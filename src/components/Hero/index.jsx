  ...
  return (
    <section className="hero mb-[35px] lg:mb-11">
      <div className="container mx-auto px-6">
        <div className="hero__inner w-full max-w-[1110px] bg-[#101010] rounded-[30px] px-6 sm:px-8 pb-0 sm:py-5 lg:py-0 text-white shadow flex justify-between lg:justify-center lg:gap-x-16 items-center">
          ...
          <a href="#">
            <img src={HeroImage} alt="Image" className="sm:w-[300px] sm:scale-125"/>
          </a>
        </div>
      </div>
    </section>
